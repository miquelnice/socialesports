...
<title>Socialesports - Regístrate</title>
...
<div class="header"> <!-- Fondo de repetición -->
	<?php include 'lib/publicidad_top.php'; ?>
		...
		<div id="wrap">
            <h3>Eres nuevo en Socialesports?</h3>
            <form action="registro.php" method="POST" enctype="multipart/form-data" id="insertant" name="insertant" onSubmit="return validar()" style="width:400px; float:left; margin-left:20px; margin-bottom:70px;">
            ...
            <input name="contrasenya" type="text" id="contrasenya" size="30" style='width:240px; float:left; margin-bottom:15px;' />
