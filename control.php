...
$visitant="SELECT *	FROM empresa WHERE nombre='$empresa' AND password = '$passwordempresa'"; //si el login existe en la BBDD
$query_visitant = mysql_query($visitant, $link);
if (@mysql_num_rows($query_visitant)){
	while ($puni2 = mysql_fetch_row($query_visitant)){
//if ($_POST["login"]=="admin" && $_POST["password"]=="d3Ny$"){ 
...
<div class="header"> <!-- Fondo de repetición -->
    ...
    <div id='mensajempresa' style="text-align:left; width:960px; margin:0px auto; z-index:0; position:relative;">
    	<h3>Acceso empresas</h3>
		<p style='font-size:14px; float:left; text-align:left; margin-left:20px; width:100%; margin-top:0px;'>El nombre de empresa o el password no son correctos.</p>
        <p><a href="acceso_empresa.php" style='font-size:14px; text-decoration:none; float:left; text-align:left; margin-left:20px; width:100%; margin-bottom:20px; color:#4a9dca'>Volver a intentarlo</a></p>
   	</div>
