...
<div class="header"> <!-- Fondo de repetición -->
	<?php include 'lib/publicidad_top.php'; ?>
		...
		<div id="registrado" style="text-align:left; width:960px; margin:0px auto; z-index:0; position:relative;">
           <h3>Registrado!</h3>
           <p style='font-size:14px; float:left; text-align:left; margin-left:20px; width:100%; margin-top:0px;'>Se ha registrado correctamente.<br/><br/>En breve recibirá un correo electrónico con sus datos.</p>
