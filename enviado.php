...
<div class="header"> <!-- Fondo de repetición -->
	...
	<div id="wrap">
        ...
        <div id='error' style='width: 920px; float:left; padding:8px; margin-top:0px; margin-left:20px; margin-bottom:40px;'>
    	    <p style='float:left; font-size:14px; color:#4a9dca; text-align:left; width:100%;'>En breve recibirás un correo recordándote tu password. </p>
        </div>
	</div>
